...
//    }
    ...
    public PreProcess(String outpath, String outprefix, String fastqfile, String linkerfile, String adapterfile, int matchscore, int mismatchscore, int indelscore, int threads) throws IOException {
        OptionListInit();
        OptionList.put(OptOutPath, outpath);
        OptionList.put(OptOutPrefix, outprefix);
        OptionList.put(OptFastqFile, fastqfile);
